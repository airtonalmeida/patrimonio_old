...
@ViewController
//@NextView("./consultaPorSTBResEditar.jsf")
@NextView("./bem_edit.jsf")
@PreviousView( "./consultaPorSubTipoBemResponsavel.jsf")
public class ConsultaBemSTBResMB extends AbstractEditPageBean<Bem, Long> {
	...
	@Transactional
	public void conBemSubTpBemRes() {
		
		if((getBean().getSubTipoBem()==null)||(getBean().getResponsavel()==null)){
			...
			FacesMessage messageNull = new FacesMessage(FacesMessage.SEVERITY_INFO, "AVISO", "Selecione o Sub Tipo do Bem e o Responsável!");
			
			RequestContext.getCurrentInstance().showMessageInDialog(messageNull);
			
		}else{
					resultado = bemBC.conListBemSubTpBemResBC(getBean());
					...
					if(!resultado.isEmpty()){
						...
						FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "AVISO", "Não há Bem cadastrado com o Sub Tipo de Bem " + getBean().getSubTipoBem().getDescricao() + " e ao Responsável " + getBean().getResponsavel().getNome());
		...
		if((getBean().getSubTipoBem()==null)||(getBean().getResponsavel()==null)){
			...
			RequestContext.getCurrentInstance().showMessageInDialog(messageNull);
				...
				if(!resultado.isEmpty()){
					...
					relatorio.showReportSTBResponsavel(resultado);
